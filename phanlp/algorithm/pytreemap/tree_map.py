...
class TreeMap(NavigableMap, AbstractMap, Map):
    ...
    from algorithm.pytreemap.tree_map_inner_class.values import Values
    from algorithm.pytreemap.tree_map_inner_class.entry_set import EntrySet
    ...
    from algorithm.pytreemap.tree_map_inner_class.key_set import KeySet
    from algorithm.pytreemap.tree_map_inner_class.private_entry_iterator \
        import PrivateEntryIterator
    from algorithm.pytreemap.tree_map_inner_class.entry_iterator import EntryIterator
    from algorithm.pytreemap.tree_map_inner_class.value_iterator import ValueIterator
    from algorithm.pytreemap.tree_map_inner_class.key_iterator import KeyIterator
    from algorithm.pytreemap.tree_map_inner_class.descending_key_iterator \
    ...
    from algorithm.pytreemap.tree_map_inner_class.navigable_sub_map import NavigableSubMap
    from algorithm.pytreemap.tree_map_inner_class.ascending_sub_map import AscendingSubMap
    from algorithm.pytreemap.tree_map_inner_class.descending_sub_map import DescendingSubMap

    """Constants for red-black tree"""
    RED = False
    BLACK = True

    from algorithm.pytreemap.tree_map_inner_class.entry import Entry
